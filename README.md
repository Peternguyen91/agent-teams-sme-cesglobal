...
> Agent Teams hỗ trợ tự động hóa các quy trình vận hành doanh nghiệp nhưng **không thay thế tư vấn chuyên môn** về tài chính, kế toán, thuế, pháp lý, hoặc nhân sự. Mọi kết quả do plugin tạo ra **cần được người dùng rà soát** và — khi cần thiết — **kiểm chứng bởi chuyên gia có chứng chỉ hành nghề** trước khi sử dụng cho mục đích chính thức.
...
### Hai cách kích hoạt kỹ năng

| Phương thức | Ví dụ | Phù hợp khi |
|---|---|---|
| **Nói chuyện tự nhiên** (khuyến nghị) | *"Tháng này dòng tiền sao rồi?"* | Người dùng không nhớ tên kỹ năng — Claude tự định tuyến |
| **Gọi trực tiếp tên kỹ năng** | *"Chạy `du-bao-dong-tien`"* hoặc tham chiếu mã kỹ năng | Cần ép Claude dùng đúng kỹ năng đó; chạy script định kỳ |

> Mã kỹ năng (in `monospace` dưới đây) là tên thư mục trong [`skills/`](./skills) và là định danh duy nhất khi cần gọi chính xác.
...
Plugin Agent Teams được phát triển dựa trên plugin **small-business** thuộc dự án [Knowledge Work Plugins](https://github.com/anthropics/knowledge-work-plugins) của **Anthropic, PBC**, phân phối theo giấy phép **Apache License 2.0**.

Phần Việt hóa, tái cấu trúc theo mô hình phòng ban doanh nghiệp Việt Nam, và các điều chỉnh kèm theo thuộc bản quyền của **Công ty Cổ phần Công nghệ Trí tuệ Nhân tạo CES GLOBAL** (2025), cũng phân phối theo giấy phép **Apache License 2.0**.

Chi tiết xem tại [`LICENSE`](./LICENSE) và [`NOTICE`](./NOTICE).
